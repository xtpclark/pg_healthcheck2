...
SELECT * FROM (SELECT current_database(), nspname AS schemaname, tblname, idxname, bs*(relpages)::bigint AS real_size,
...
ORDER BY bloat_size, nspname, tblname, idxname) AS data
WHERE schemaname !='pg_catalog' AND bloat_pct > 9 ORDER BY bloat_pct, bloat_size ASC LIMIT 10;
"""
