def run_postgres_overview(cursor, settings, execute_query, execute_pgbouncer):
    ...
    """
    adoc_content = ["=== PostgreSQL Overview", "Provides an overview of the PostgreSQL database, including version, uptime, size, and key configuration settings."]
    ...
    queries = [
        ...
        ("Uptime", "SELECT setting AS uptime FROM pg_settings WHERE name = 'pg_uptime';", settings['is_aurora'] == 'false', "uptime"), # Aurora-specific condition
