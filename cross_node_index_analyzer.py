...
class CrossNodeIndexAnalyzer:
    ...
    def identify_unused_indexes(self) -> List[Dict]:
        ...
        if not isinstance(unused_indexes, list):
            print(f"[WARN] identify_unused_indexes did not return a list ({type(unused_indexes)}), returning empty list instead.")
            return []
    ...
    def generate_report(self, unused_indexes: list, removal_sql: list, output_file: str):
        ...
        report_content = []
        # Defensive: ensure unused_indexes is a list
        if not isinstance(unused_indexes, list):
            print(f"[WARN] generate_report received non-list ({type(unused_indexes)}), using empty list.")
            unused_indexes = []
        ...
        for node_name, node_data in self.index_data.items():
            ...
            report_content.extend([
                ...
                f"- Unused indexes: {unused_indexes}",
...
def main():
    ...
    if not isinstance(unused_indexes, list):
        print(f"[WARN] main: unused_indexes is not a list ({type(unused_indexes)}), using empty list.")
        unused_indexes = []
